...
INSERT INTO "new_Resource" ("content", "createdAt", "description", "duration", "filePath", "id", "metadata", "order", "partId", "sectionId", "thumbnail", "title", "topicId", "type", "unitId", "updatedAt", "url", "usageCount", "userId") SELECT "content", "createdAt", "description", "duration", "filePath", "id", "metadata", "order", "partId", "sectionId", "thumbnail", "title", "topicId", "type", "unitId", "updatedAt", "url", "usageCount", "userId" FROM "Resource";
DROP TABLE "Resource";
